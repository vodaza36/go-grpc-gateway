...
func (*PingMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_7c48a3359f5b4ef9, []int{0}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_7c48a3359f5b4ef9) }

var fileDescriptor_api_7c48a3359f5b4ef9 = []byte{
