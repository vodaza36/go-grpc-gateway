...
func (*PingMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_a38d34a7df3db2f5, []int{0}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_a38d34a7df3db2f5) }

var fileDescriptor_api_a38d34a7df3db2f5 = []byte{
